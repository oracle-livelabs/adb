...
As mentioned previously, Autonomous Database makes it easy to create partitioned external tables over sources that use common data lake organizations. You can think of a partitioned table as being a sin
