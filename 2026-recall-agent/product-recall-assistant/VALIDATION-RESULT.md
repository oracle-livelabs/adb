# LiveLabs Workshop Validation – product-recall-assistant

Generated on 2026-09-09T09:22:56.082823+00:00

## Structure Check
- ❌ Issues detected:
  - react-app missing react-app.md file.
  - archive missing archive.md file.
- ⚠️ Warnings:
  - react-app missing images/ folder (required for screenshots).
  - archive missing images/ folder (required for screenshots).
  - deploy missing images/ folder (required for screenshots).
...
### build-recall-assistant/build-recall-assistant.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 3/5
...
### facilitator/lab1-runbook.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 4/5
  - 2 sentence(s) exceed 20 words; tighten wording.

### facilitator/lab2-runbook.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 4/5
  - 1 sentence(s) exceed 20 words; tighten wording.

### facilitator/lab3-runbook.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 4/5
  - Passive voice detected in 1 instance(s).

### facilitator/lab4-runbook.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 5/5

### facilitator/lab8-runbook.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 3/5
...
### investigate-recall/investigate-recall.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 4/5
  - 6 sentence(s) exceed 20 words; tighten wording.

### map-recall-impact/map-recall-impact.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 3/5
  - 3 sentence(s) exceed 20 words; tighten wording.
  - Passive voice detected in 1 instance(s).

### prioritize-recall-evidence/prioritize-recall-evidence.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 3/5
  - 5 sentence(s) exceed 20 words; tighten wording.
  - Passive voice detected in 2 instance(s).

### publish-recall-workflow/publish-recall-workflow.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 3/5
  - 2 sentence(s) exceed 20 words; tighten wording.
  - Passive voice detected in 1 instance(s).
...
- ❌ Formatting issues:
  ...
  - Missing 'Estimated Time:' line.
- ✍️ Lanham score: 2/5
  - 78 sentence(s) exceed 20 words; tighten wording.
...
- ❌ Formatting issues:
  ...
  - Missing 'Estimated Time:' line.
- ✍️ Lanham score: 2/5
  - 52 sentence(s) exceed 20 words; tighten wording.
...
### react-recall-command-center/react-recall-command-center.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 2/5
...
### secure-recall-agent/secure-recall-agent.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 3/5
  - 13 sentence(s) exceed 20 words; tighten wording.
  - Passive voice detected in 1 instance(s).

### trace-supply-network/trace-supply-network.md
- ✅ LiveLabs formatting checks passed.
- ✍️ Lanham score: 3/5
  - 4 sentence(s) exceed 20 words; tighten wording.
  - Passive voice detected in 1 instance(s).
