...
**Companion workshop:** This workshop focuses on logs using a push model to Grafana Loki. For metrics using a pull model with ORDS and Prometheus, see the companion workshop: [*Build a Prometheus-Compatible Telemetry Endpoint for ADB-D Using ORDS*](../../adb-prometheus/workshop/db-users/index.md).
