...
The purpose of this lab is to help you understand how to develop business logic required to integrate Generative AI with data from the Autonomous Database. You will use to key APIs to accomplish the task: **`DBMS_CLOUD_AI.CREATE_PROFILE`** and **`DBMS_CLOUD_AI.GENERATE`**.  
