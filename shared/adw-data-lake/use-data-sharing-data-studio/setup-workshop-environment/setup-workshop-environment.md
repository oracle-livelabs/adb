...
Since you are using the LiveLabs environment, all of the OCI resources that you need in this workshop are already created for you with your LiveLabs reservation including an Oracle Autonomous Database instance.
