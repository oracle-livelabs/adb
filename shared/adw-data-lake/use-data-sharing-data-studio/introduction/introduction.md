...
* _Data Studio in Autonomous AI Database (ADB) using delta sharing protocol_ _**(covered in this workshop)**_
* Data Studio in Autonomous AI Database (ADB) using Cloud links
