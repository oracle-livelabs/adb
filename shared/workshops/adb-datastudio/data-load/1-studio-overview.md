...
- Familiarize with the Data Studio application
...
Autonomous Data Warehouse comes with a built-in Data Studio application that can help you with many of the typical data warehouse tasks. This application is complementary to various capabilities accessible via the SQL command line, which themselves are covered by other workshops.  
