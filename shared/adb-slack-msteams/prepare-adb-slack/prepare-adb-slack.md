...
Slack, a leading collaboration tool, provides teams to have seamless communication and efficient data management. Also, Slack has cool integrations with external app and sources. This is precisely what unites Oracle Autonomous Database and Slack in this lab.

This lab walks you through the steps to configure your Slack application to receive messages,alerts and output of a query from Autonomous Database. Also, you will learn the required procedures to send Slack notifications.

Before we started, this lab requires the following:

+ Slack account and workspace
+ Slack app
+ Slack channel

> **Note:** A Slack workspace is made up of channels, where team member can communicate and work together. To join a workspace, you will [create an account](https://slack.com/get-started#/createnew) using your email address.
...
3. Enter your **App Name**, then select your **Workspace**, and click **Create App**.
...
1. Go to [main application page](https://api.slack.com/apps), then click your **App Name**.
...
3. Scroll down to **Scopes**, and click **Add an OAuth Scope**.

    ![Open ADB](./images/click-add-scope.png "")

4. For OAuth Scope, enter **channels:read**, and select the scope from drop-down list. This scope allows your app to access public Slack channels.
...
6. Repeat Task 5, to add these scopes **chat:write** and  **files:write** to your application as well.

## Task 4: Create a  Slack channel

To use Slack with DBMS_CLOUD_NOTIFICATION procedure, your Slack admin must add the Slack app to the channels so that you can send message through the **Integrations** in the channel.

1. To create a Slack channel, open the Slack app and click **Add channels**.
...
3. Enter a **Name** for your channel, and click **Next**.

    ![Open ADB](./images/click-next2.png "")

4. If successful, you will see your channel in your workspace. Click your **Channel name** (arrow icon), and then select **Integrations**.
...
## Task 5: Create a credential object to access the Slack application from Autonomous Database
...
## Task 6: Configure access control to allow user access to external network services
   ...
   ```
    ...
    BEGIN
       DBMS_NETWORK_ACL_ADMIN.APPEND_HOST_ACE (
          ...
          principal_name => enter_database_user_name_or_role,
...
1. Copy and paste the following code into your SQL Worksheet, and enter your **Channel ID**, then click the **Run Script (F5)**.
...
3. Select your channel, click **Get Channel Details**, scroll down to the bottom, and copy the **Channel ID**.
...
2. Enter the following script, enter your **Channel ID** into **params** and then click **Run Statement**.
